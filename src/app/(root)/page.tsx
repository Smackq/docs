...
export default async function Home() {
  ...
  return (
    ...
    <section className="w-full h-[530px] bg-red-400 flex flex-col justify-center items-center">
      <h1 className=" text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white p-5 bg-black font-bold">Create your own contract</h1>
      <p className="text-white text-[20px] mt-6">This application generates up-to-date contracts in many areas of activity.</p>
